          ...
          <nav className="w-full flex justify-between gap-6 relative">
            ...
            >
              <div className="hidden lg:flex flex-1 justify-center">
                <ul
                  className="border-t border-box-border lg:border-t-0 px-6 lg:px-6 
                      pt-6 lg:pt-0 flex flex-col lg:flex-row gap-x-9 gap-y-4 text-lg text-heading-2
