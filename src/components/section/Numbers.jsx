...
const Numbers = () => {
  return (
    <section className="relative mt-12 md:mt-16 ">
      <Container className="flex justify-center align-center items-center">
        <div
          className="mx-auto lg:mx-0 p-5 sm:p-6 sm:py-8 max-w-5xl rounded-3xl bg-box-bg 
                border border-box-border shadow-lg shadow-box-shadow md:divide-x md:divide-box-border
        ...
        >
          ...
          <div className="text-center px-5 ">
            ...
            <p className="mt-2 text-heading-3 ">Yours of Innovation</p>
          </div>
        </div>
      </Container>
    </section>
