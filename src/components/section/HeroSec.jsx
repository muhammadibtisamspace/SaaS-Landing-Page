    ...
    <section className="relative pt-32 lg:pt-36 ">
      ...
      <Container classname="flex flex-col lg:flex-row gap-10 lg:gap-12 ">
        <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 ">
          ...
          <span
            className="absolute right-4 bottom-12 w-24
             h-24 rounded-3xl bg-primary blur-xl opacity-80"
          ></span>
        </div>

        <div
          className="relative flex flex-col items-center text-center
             lg:text-left lg:py-8 lg:items-start lg:max-w-none max-w-3xl lg:mx-0 lg:flex-1 lg:w-1/2"
        >
          <h1 className="text-heading-1 text-3xl sm:text-4xl  md:text-5xl xl:text-6xl ">
            Empower Your Business
            <span
              className="text-transparent bg-clip-text
                bg-gradient-to-r from-blue-600 to-violet-600 ml-2"
            >
              With Ai
            </span>
          </h1>
          ...
          <Paragraph className="mt-8 ">
            ...
            Runs Faster, Smarter and More Efficiently.
          </Paragraph>
            ...
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              <form
                ...
                className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3
                   shadow-lg shadow-box-shadow border-box-border bg-box-bg rounded-full ease-linear 
              ...
              >
                ...
                <input
                  type="email"
                  placeholder="Muhammadibtisam777@gmail.com"
                  className="w-full py-3 outline-none bg-transparent"
                />

                <SubmitButton className="min-w-max text-white">
        ...
        <div
          className=" flex flex-1 lg:w-1/2  lg:h-auto relative 
          lg:max-w-none lg:mx-0 mx-auto max-w-3xl"
        >
          <img
