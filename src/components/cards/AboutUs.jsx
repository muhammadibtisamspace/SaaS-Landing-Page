        ...
        <div className="w-full md:w-7/12 lg:w-1/2 flex flex-col">
          <Title>
            ...
            <Paragraph>
              ...
              With Innovative Algorithms To Deliver A Platfrom That Adapts To
              Your Unique Needs. Join Us And Lead The Digital rovolution In Your
              Industry.
            </Paragraph>
          </Title>
          ...
          <div className="pt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl ">
            <Info
              title="Mission"
              description="Our Mission is to use AI for the good of humanity and planet."
            >
              <svg
